...
const registerUser = asyncHandler( async (req, res) => {
    ...
    // check for user creation from db
    ...
    if([fullname, email, username, password].some((field) => field ?.trim() === "")) {
        // here method some will call cb method for every element in the array
        // if anyone of the element equals to an empty array("") it will return true 
